...
import { Button, Image, ImageBackground, ScrollView, Text, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
...
const ItemsList = () => {
    ...
    return (
        <>
            <ScrollView>
                <ProductListingHeader modalOpen={headerModal} setModalOpen={setHeaderModal} />
                <View
                    style={{
